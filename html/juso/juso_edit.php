...
<?
    ...
    $query = "select * from juso where no21=$no;";
...
<form name="form1" method="post" action="juso_update.php"> <!-- html-> php -->
...
<table width="500" border="1" cellpadding="2" bgcolor="lightyellow" style="border-collapse:collapse">
  <tr>
    ...
    <td width="400" align="left">
      <input type="text" name="name" size="10" value="<?=$row[name21]?>">   <!-- name21 -->
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="400" align="left">
      <input type="text" name="juso" size="40" value="<?=$row[juso21]?>">  <!--juso -->
    </td>
  </tr>
</table>
<br>
