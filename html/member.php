...
<table width="800" border="0">
	...
	<tr height="40">
		<td width="200" valign="bottom">&nbsp 회원수 : <font color="#FF0000"><?echo("$total_rows");?></font></td>
...
<table width="800" border="1" cellpadding="2" style="border-collapse:collapse">
	...
	<?
		...
		for ($i = 0; $i < $page_last; $i++) {
			...
			if ($row[gubun21]==0) $gb="회원"; else $gb="탈퇴";
			...
			echo("<tr bgcolor='#F2F2F2' height='23'>	
					...
					<td width='100' align='center'>$gb</td>	
					<td width='100' align='center'>
						<a href='member_edit.php?no=$row[no21]&page=$page&sel1=$sel1&text1=$text1'>수정</a>
						<a href='member_delete.html?no=1&page=$page&sel1=$sel1&text1=$text1' onclick='javascript:return confirm('삭제할까요 ?');'>삭제</a>
					</td>
				</tr>");
		}
?>
