               ...
               <td width="465" align="center">
                  <table width="86%" border="0" cellspacing="5" cellpadding="0">
                     ...
                     <tr> 
                        ...
                        <td width="214"><a href = "javascript:SearchZip()"><img src="images/b_search.gif" border="0"></a></td>
                     </tr>
                  </table>
               </td>
               <td width="16">&nbsp;</td>
...
<table width="500" border="0"cellpadding="0"cellspacing="0">
   ...
   <tr height="30"> 
      <td align="center">
         ...
         <?
            ...
            if ($text1 && $sel != 0) { // 검색어가 있고 시도선택이 있는경우
               for ($i = 0; $i < $count; $i++) {
   ...
   <tr height="55"> 
      <td align="center">
         <?
            if($zip_kind == 0) echo("<a href='javascript:SendZip(0)'><img src='images/b_ok1.gif' border='0'></a>");
            else if($zip_kind == 1) echo("<a href='javascript:SendZip(1)'><img src='images/b_ok1.gif' border='0'></a>");
            else echo("<a href='javascript:SendZip(2)'><img src='images/b_ok1.gif' border='0'></a>");
         ?>
      </td>
   </tr>
</form>
