...
<?
   ...
   $birthday1=substr($row[birthday21],0,4);
   $birthday2=substr($row[birthday21],5,2);
...
<table width="600" border="1" cellpadding="2"  style="border-collapse:collapse">
   <tr height="20"> 
      ...
      <td width="500" bgcolor="#F2F2F2"><?=$row[uid21]?></td>
   </tr>
   <tr height="20"> 
      <td width="100" align="center" bgcolor="#CCCCCC">암호</td>
      <td width="500" bgcolor="#F2F2F2">
         <input type="text" name="pwd" value="<?=$row[pwd21]?>" size="20" maxlength="20">
      </td>
   </tr>
   <tr height="20"> 
   ...
   <tr height="20"> 
      ...
      <td width="500" bgcolor="#F2F2F2">
         <input type="text" name="email" value="<?=$row[email21]?>" size="40" maxlength="40">
      </td>
   </tr>
   <tr height="20"> 
      <td width="100" align="center" bgcolor="#CCCCCC">주소</td>
      <td width="500" bgcolor="#F2F2F2">
         <input type="text" name="zip" value="<?=$row[zip21]?>" size="5" maxlength="5"> &nbsp 
         <input type="button" value="우편번호 찾기" onClick="javascript:OpenWinZip(0);"> <br>
         <input type="text" name="juso" value="<?=$row[juso21]?>" size="60" maxlength="100">
      </td>
   </tr>
   <tr height="20"> 
