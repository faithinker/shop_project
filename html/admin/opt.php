...
<?
    ...
    $query = "select * from opt order by no21;";				// sql 정의
...
<?
    for ($i = 0; $i < $count; $i++) {
		...
		<td width='100' align='center'>
			<a href='opt_edit.php?no1=$row[no21]'>수정</a>/
			<a href='opt_delete.php?no1=$row[no21]'onclick='javascript:return confirm(\"삭제할까요 ?\");'>삭제</a>
		</td>
